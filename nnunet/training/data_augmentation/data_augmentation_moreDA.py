...
from nnunet.training.data_augmentation.custom_transforms import SpatialTransform_GSW, ConcatWithOriginal
...
def get_moreDA_augmentation_ssl(dataloader_train_labeled, dataloader_train_unlabeled, dataloader_val,
                                patch_size, params=default_3D_augmentation_params, border_val_seg=-1,
                            seeds_train=None, seeds_val=None, order_seg=1, order_data=3, deep_supervision_scales=None,
                            soft_ds=False,
                            classes=None, pin_memory=True, regions=None,
                            use_nondetMultiThreadedAugmenter: bool = False):
    ...
    if use_nondetMultiThreadedAugmenter:
        if NonDetMultiThreadedAugmenter is None:
            raise RuntimeError('NonDetMultiThreadedAugmenter is not yet available')
        batchgenerator_train_labeled = NonDetMultiThreadedAugmenter(dataloader_train_labeled, tr_transforms, params.get('num_threads'),
                                                            params.get("num_cached_per_thread"), seeds=seeds_train,
                                                            pin_memory=pin_memory)
        batchgenerator_train_unlabeled = NonDetMultiThreadedAugmenter(dataloader_train_unlabeled, tr_transforms, params.get('num_threads'),
                                                            params.get("num_cached_per_thread"), seeds=seeds_train,
                                                            pin_memory=pin_memory)
    else:
        batchgenerator_train_labeled = MultiThreadedAugmenter(dataloader_train_labeled, tr_transforms, params.get('num_threads'),
                                                      params.get("num_cached_per_thread"),
                                                      seeds=seeds_train, pin_memory=pin_memory)
        batchgenerator_train_unlabeled = MultiThreadedAugmenter(dataloader_train_unlabeled, tr_transforms,
    ...
    return batchgenerator_train_labeled, batchgenerator_train_unlabeled, batchgenerator_va
