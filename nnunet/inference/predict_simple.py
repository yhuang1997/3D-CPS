...
from convert_spacing import convert_target_spacing, convert_original_spacing
...
def main():
    ...
    parser.add_argument('--fixed_spacing', required=False, type=float, default=None, nargs='+')
    parser.add_argument('--disable_pp', required=False, default=False, action="store_true")
    ...
    fixed_spacing = args.fixed_spacing
    ...
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        ...
        predict_from_folder(model_folder_name, input_folder, lowres_output_folder, folds, False,
                            ...
                            step_size=step_size, disable_postprocessing=args.disable_pp)
    ...
    #     convert_target_spacing(input_folder, "/workspace/temp/inputs-preprocessed/", target_spacing_z=fixed_spacing)
    #     input_folder = "/workspace/temp/inputs-preprocessed/"
    #     real_output_folder = output_folder
    #     output_folder = "/workspace/temp/outputs-preprocessed/"

    inference_suffix = "task{}_{}_{}_fold{}_{}_{}".format(task_id,
                                                          args.plans_identifier,
    ...
    # if fixed_spacing is not None:
    #     spacing_pkl_path = "/workspace/temp/inputs-preprocessed/spacing.pkl"
    #     convert_original_spacing(output_folder, real_output_folder, spacing_pkl_path)
